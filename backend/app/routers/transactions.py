...
def create_transaction(
    ...
    The account must belong to the current user — we validate this here to
    prevent a user creating transactions on accounts they don't own.

    user_id is always taken from the JWT — the client cannot choose it.
    """
...
def update_transaction(
    ...
    # If the client is moving the transaction to a different account,
    # validate the new account belongs to them.
