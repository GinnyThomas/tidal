...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_transactions_schedule_id_schedules', 'transactions', 'schedules', ['schedule_id'], ['id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_transactions_schedule_id_schedules', 'transactions', type_='foreignkey')
